    ...
    <header class="site-header">
      <div class="container nav-wrap">
        ...
        <nav class="nav-links" id="primary-navigation" aria-label="Primary navigation">
          <a href="${base}index.html">Home</a><a href="${base}template-maker.html">Template Maker</a><a href="${base}chat-flows.html">Chat Flows</a><a href="${base}premium-templates.html">Templates</a><a href="${base}blog.html">Blog</a><a href="${base}about.html">About</a><a href="${base}contact.html">Contact</a>
        </nav>
